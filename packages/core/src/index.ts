...
// Toolkits — base only. The 30+ concrete toolkits live behind their own entry
// point so importing `Agent` does not pull every integration into the bundle:
//   import { GitHubToolkit } from "@agentium/core/toolkits";
export type { ToolkitConfigField, ToolkitMeta } from "./toolkits/base.js";
